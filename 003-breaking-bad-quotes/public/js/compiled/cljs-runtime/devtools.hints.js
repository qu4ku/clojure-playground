...
var G__26420 = cljs.core.PersistentArrayMap.EMPTY;
var G__26421 = native_stack_trace;
var G__26422 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__26423 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__26420,G__26421,G__26422,G__26423) : cljs.stacktrace.parse_stacktrace.call(null,G__26420,G__26421,G__26422,G__26423));
});
...
var map__26425 = top_item;
var map__26425__$1 = (((((!((map__26425 == null))))?(((((map__26425.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26425.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__26425):map__26425);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26425__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26425__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26425__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e26424){var _e = e26424;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___26430 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5718__auto___26430)){
var seen_errors_26431 = temp__5718__auto___26430;
if(cljs.core.truth_(seen_errors_26431.has(self))){
} else {
seen_errors_26431.add(self);

var temp__5720__auto___26432 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5720__auto___26432)){
var sense_26433 = temp__5720__auto___26432;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26433)].join('');
} else {
}
}
} else {
