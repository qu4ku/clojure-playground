...
var o28562 = temp__5718__auto__;
var temp__5718__auto____$1 = (o28562["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o28563 = temp__5718__auto____$1;
return (o28563["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26842__auto__ = f;
return (o__26842__auto__["toString"]).call(o__26842__auto__);
} else {
return "";
}
}catch (e28564){var _ = e28564;
return "";
}});
...
try{var o__26842__auto___28695 = t;
(o__26842__auto___28695["cljs$lang$ctorPrWriter"]).call(o__26842__auto___28695,t,writer);
}catch (e28565){var __28696 = e28565;
}
...
var char_code = (function (){var o__26842__auto__ = (new String(char$));
return (o__26842__auto__["charCodeAt"]).call(o__26842__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26842__auto__ = String;
return (o__26842__auto__["fromCharCode"]).call(o__26842__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28566 = num_code;
switch (G__28566) {
case (1):
return (185);
...
var o__26842__auto__ = String;
return (o__26842__auto__["fromCharCode"]).call(o__26842__auto__,superscript_code);
});
/**
...
}catch (e28567){var _e__26919__auto__ = e28567;
return false;
}})())){
...
var vec__28568 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28568,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o28572 = temp__5718__auto__;
var temp__5718__auto____$1 = (o28572["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o28573 = temp__5718__auto____$1;
return (o28573["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28576){
var vec__28577 = p__28576;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28577,(0),null);
...
var G__28730 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28731 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28730;
remaining_tokens = G__28731;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28574){
var G__28575 = cljs.core.first(seq28574);
var seq28574__$1 = cljs.core.next(seq28574);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28575,seq28574__$1);
});
...
var vec__28586 = cljs.core.split_with((function (p1__28585_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28585_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28586,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28586,(1),null);
...
var vec__28597 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28597,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28597,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28733 = cljs.core.rest(remaining_tokens);
var G__28734 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28733;
name_tokens = G__28734;
continue;
} else {
...
var vec__28602 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28602,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28602,(1),null);
var vec__28605 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28605,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28605,(1),null);
var vec__28608 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28608,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28608,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28608,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28608,(3),null);
...
var vec__28618 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28618,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28618,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28618,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28618,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28618,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28618,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__28621 = temp__5718__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28621,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28621,(1),null);
var vec__28624 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28624,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28624,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28627 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28627) : devtools.munging.parse_fn_info_deep.call(null,G__28627));
})()));
}
} else {
return fn_info;
...
var G__28743 = (arity + (1));
var G__28744 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28643_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28644_SHARP_);
...
var G__28759 = (i__4731__auto___28756 + (1));
i__4731__auto___28756 = G__28759;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28647){
var vec__28648 = p__28647;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28648,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28645){
var G__28646 = cljs.core.first(seq28645);
var seq28645__$1 = cljs.core.next(seq28645);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28646,seq28645__$1);
});
...
var map__28663 = options;
var map__28663__$1 = (((((!((map__28663 == null))))?(((((map__28663.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28663.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28663):map__28663);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28663__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28663__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28663__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28663__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28664 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28664,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28664,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28664,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28664,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28664,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28664,(5),null);
...
var o__26842__auto__ = f;
return (o__26842__auto__["getBasis"]).call(o__26842__auto__);
});
/**
...
}catch (e28671){var _e__26919__auto__ = e28671;
...
var G__28790 = (obj[cljs.core.first(path)]);
var G__28791 = cljs.core.rest(path);
obj = G__28790;
path = G__28791;
continue;
} else {
...
return (function (accum,p__28676){
var vec__28677 = p__28676;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28677,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28677,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28680){
var vec__28681 = p__28680;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28681,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28681,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28681,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28686,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28686,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__28686,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__28684_SHARP_){
return (obj[cljs.core.first(p1__28684_SHARP_)]);
});})(name,sorted_matches,vec__28686,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
