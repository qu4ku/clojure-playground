...
var G__37569 = o;
(G__37569[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37571){
...
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37572__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37574){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37575__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__37575,map__37575__$1,on_write){
return (function (){
...
});})(node_value,map__37575,map__37575__$1,on_write))
);
} else {
...
reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__37583){
...
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37584__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37584__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__37592 = jsprops;
(G__37592["defaultValue"] = value);

(G__37592["onChange"] = ((function (G__37592,v,value,on_change,on_change__$1,map__37584,map__37584__$1,synthetic_on_update,synthetic_on_change){
return (function (p1__37580_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__37580_SHARP_);
});})(G__37592,v,value,on_change,on_change__$1,map__37584,map__37584__$1,synthetic_on_update,synthetic_on_change))
);
...
var vec__37599 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37599,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37599,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37599,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___37732 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___37732 == null)){
} else {
var key_37733 = temp__5724__auto___37732;
(jsprops["key"] = key_37733);
}
...
reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__37605){
...
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37606__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__37608 = reagent.impl.template.__GT_NativeWrapper();
(G__37608["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__37609 = wrapped;
(G__37609["syntheticInput"] = true);

return G__37609;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__37610 = wrapped__$1;
(G__37610["syntheticOnChange"] = on_change);

return G__37610;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__37611 = wrapped__$2;
(G__37611["syntheticOnUpdate"] = on_update);
...
var len__4730__auto___37736 = arguments.length;
var i__4731__auto___37737 = (0);
while(true){
if((i__4731__auto___37737 < len__4730__auto___37736)){
args__4736__auto__.push((arguments[i__4731__auto___37737]));

var G__37738 = (i__4731__auto___37737 + (1));
i__4731__auto___37737 = G__37738;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37618){
var G__37619 = cljs.core.first(seq37618);
var seq37618__$1 = cljs.core.next(seq37618);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37619,seq37618__$1);
});
...
break;
default:
var G__37740 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__37740;
continue;
...
var n__4607__auto___37741 = a.length;
var i_37742 = (0);
while(true){
if((i_37742 < n__4607__auto___37741)){
(a[i_37742] = reagent.impl.template.as_element((a[i_37742])));

var G__37743 = (i_37742 + (1));
i_37742 = G__37743;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___37744 = a.length;
var i_37745 = (0);
while(true){
if((i_37745 < n__4607__auto___37744)){
var val_37746 = (a[i_37745]);
if(((cljs.core.vector_QMARK_(val_37746)) && ((reagent.impl.template.key_from_vec(val_37746) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_37745] = reagent.impl.template.as_element(val_37746));

var G__37747 = (i_37745 + (1));
i_37745 = G__37747;
continue;
} else {
}
...
var ctx = ({});
var vec__37647 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37647,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37647,(1),null);
...
var G__37658 = (cljs.core.count(argv) - first_child);
switch (G__37658) {
case (0):
...
case (1):
var G__37659 = comp;
var G__37660 = jsprops;
var G__37661 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__37659,G__37660,G__37661);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__37658){
