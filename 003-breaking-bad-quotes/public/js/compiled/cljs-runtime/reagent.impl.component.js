...
if((i < len)){
var k = (ks[i]);
var G__37562 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__37563 = (i + (1));
m = G__37562;
i = G__37563;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__37532 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__37532);
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__37534 = c;
var G__37534__$1 = (((G__37534 == null))?null:G__37534.prototype);
if((G__37534__$1 == null)){
return null;
} else {
return (G__37534__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__37536 = c;
var G__37536__$1 = (((G__37536 == null))?null:G__37536.prototype);
if((G__37536__$1 == null)){
return null;
} else {
return (G__37536__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__37565__delegate = function (args){
var G__37544 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__37544) : reagent.impl.component.as_element.call(null,G__37544));
};
...
while (G__37566__i < G__37566__a.length) {G__37566__a[G__37566__i] = arguments[G__37566__i + 0]; ++G__37566__i;}
  args = new cljs.core.IndexedSeq(G__37566__a,0,null);
} 
return G__37565__delegate.call(this,args);};
...
return G__37565__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__37545 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__37546 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__37546;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__37545;
}});
...
var c = this;
var G__37548_37587 = (c["cljsRatom"]);
if((G__37548_37587 == null)){
} else {
reagent.ratom.dispose_BANG_(G__37548_37587);
}
...
var renders_37589 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_37590 = cljs.core.first(cljs.core.vals(renders_37589));
if((cljs.core.count(renders_37589) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_37589))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_37590)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_37590], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__37549 = name;
switch (G__37549) {
case "":
...
var G__37551 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__37551);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__37552 = fiber;
var G__37552__$1 = (((G__37552 == null))?null:(G__37552["type"]));
if((G__37552__$1 == null)){
return null;
} else {
return (G__37552__$1["displayName"]);
}
})();
var parent = (function (){var G__37553 = fiber;
if((G__37553 == null)){
return null;
} else {
return (G__37553["return"]);
}
})();
var path = (function (){var G__37554 = parent;
var G__37554__$1 = (((G__37554 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__37554) : reagent.impl.component.fiber_component_path.call(null,G__37554)));
if((G__37554__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37554__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var G__37555 = c;
if((G__37555 == null)){
return null;
} else {
return (G__37555["_reactInternalFiber"]);
}
})();
...
var elem = (function (){var G__37556 = (function (){var or__4131__auto__ = (function (){var G__37558 = c;
if((G__37558 == null)){
return null;
} else {
return (G__37558["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return (G__37556["_currentElement"]);
}
})();
var name = (function (){var G__37559 = elem;
var G__37559__$1 = (((G__37559 == null))?null:(G__37559["type"]));
if((G__37559__$1 == null)){
return null;
} else {
return (G__37559__$1["displayName"]);
}
})();
var path = (function (){var G__37560 = elem;
var G__37560__$1 = (((G__37560 == null))?null:(G__37560["_owner"]));
var G__37560__$2 = (((G__37560__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__37560__$1) : reagent.impl.component.component_path.call(null,G__37560__$1)));
if((G__37560__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37560__$2)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__37561 = c;
var G__37561__$1 = (((G__37561 == null))?null:G__37561.constructor);
if((G__37561__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__37561__$1);
}
}
})();
