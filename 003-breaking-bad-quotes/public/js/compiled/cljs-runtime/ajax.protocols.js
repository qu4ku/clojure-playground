...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k26028,else__4388__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k26028,else__4388__auto__);
...
var k__4408__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26034,(0),null);
var v__4409__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26034,(1),null);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__26027){
var self__ = this;
var G__26027__$1 = this;
return (new cljs.core.RecordIter((0),G__26027__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__4243__auto____$1 = (function (){var fexpr__26037 = ((function (h__4243__auto__,this__4381__auto____$1){
return (function (coll__4382__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4382__auto__));
});})(h__4243__auto__,this__4381__auto____$1))
;
return fexpr__26037(this__4381__auto____$1);
})();
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this26029,other26030){
var self__ = this;
var this26029__$1 = this;
return (((!((other26030 == null)))) && ((this26029__$1.constructor === other26030.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26029__$1.status,other26030.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26029__$1.body,other26030.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26029__$1.status_text,other26030.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26029__$1.headers,other26030.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26029__$1.was_aborted,other26030.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26029__$1.__extmap,other26030.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__26027){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__26038 = cljs.core.keyword_identical_QMARK_;
var expr__26039 = k__4393__auto__;
if(cljs.core.truth_((function (){var G__26041 = new cljs.core.Keyword(null,"status","status",-1997798413);
var G__26042 = expr__26039;
return (pred__26038.cljs$core$IFn$_invoke$arity$2 ? pred__26038.cljs$core$IFn$_invoke$arity$2(G__26041,G__26042) : pred__26038.call(null,G__26041,G__26042));
})())){
return (new ajax.protocols.Response(G__26027,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__26043 = new cljs.core.Keyword(null,"body","body",-2049205669);
var G__26044 = expr__26039;
return (pred__26038.cljs$core$IFn$_invoke$arity$2 ? pred__26038.cljs$core$IFn$_invoke$arity$2(G__26043,G__26044) : pred__26038.call(null,G__26043,G__26044));
})())){
return (new ajax.protocols.Response(self__.status,G__26027,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__26045 = new cljs.core.Keyword(null,"status-text","status-text",-1834235478);
var G__26046 = expr__26039;
return (pred__26038.cljs$core$IFn$_invoke$arity$2 ? pred__26038.cljs$core$IFn$_invoke$arity$2(G__26045,G__26046) : pred__26038.call(null,G__26045,G__26046));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__26027,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__26047 = new cljs.core.Keyword(null,"headers","headers",-835030129);
var G__26048 = expr__26039;
return (pred__26038.cljs$core$IFn$_invoke$arity$2 ? pred__26038.cljs$core$IFn$_invoke$arity$2(G__26047,G__26048) : pred__26038.call(null,G__26047,G__26048));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__26027,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__26049 = new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828);
var G__26050 = expr__26039;
return (pred__26038.cljs$core$IFn$_invoke$arity$2 ? pred__26038.cljs$core$IFn$_invoke$arity$2(G__26049,G__26050) : pred__26038.call(null,G__26049,G__26050));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__26027,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4393__auto__,G__26027),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__26027){
var self__ = this;
var this__4384__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__26027,self__.__extmap,self__.__hash));
});
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__26031){
var extmap__4424__auto__ = (function (){var G__26051 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__26031,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__26031)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__26051);
} else {
return G__26051;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__26031),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__26031),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__26031),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__26031),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__26031),null,cljs.core.not_empty(extmap__4424__auto__),null));
});
