...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__26430){
...
var request = map__26431__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26431__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__26435 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__26435.cljs$core$IFn$_invoke$arity$1 ? fexpr__26435.cljs$core$IFn$_invoke$arity$1(response) : fexpr__26435.call(null,response));
});

ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__26436 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__26436.cljs$core$IFn$_invoke$arity$1 ? fexpr__26436.cljs$core$IFn$_invoke$arity$1(response) : fexpr__26436.call(null,response));
});
});

ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2;

ajax.formats.accept_header = (function ajax$formats$accept_header(p__26437){
...
var request = map__26438__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26438__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
