...
var G__37957 = o;
(G__37957[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
G__38038.cljs$lang$applyTo = (function (arglist__38044){
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37962){
...
var props = map__37964__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37964__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37966){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37967__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__37978){
...
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37979__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37979__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__37981 = jsprops;
(G__37981["defaultValue"] = value);

(G__37981["onChange"] = (function (p1__37975_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__37975_SHARP_);
}));
...
var vec__37983 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37983,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37983,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37983,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___38100 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___38100 == null)){
} else {
var key_38101 = temp__5739__auto___38100;
(jsprops["key"] = key_38101);
}
...
(reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__37989){
...
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37990__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__37992 = reagent.impl.template.__GT_NativeWrapper();
(G__37992["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__37993 = wrapped;
(G__37993["syntheticInput"] = true);

return G__37993;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__37994 = wrapped__$1;
(G__37994["syntheticOnChange"] = on_change);

return G__37994;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__37995 = wrapped__$2;
(G__37995["syntheticOnUpdate"] = on_update);
...
var len__4789__auto___38116 = arguments.length;
var i__4790__auto___38117 = (0);
while(true){
if((i__4790__auto___38117 < len__4789__auto___38116)){
args__4795__auto__.push((arguments[i__4790__auto___38117]));

var G__38118 = (i__4790__auto___38117 + (1));
i__4790__auto___38117 = G__38118;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38020){
...
break;
default:
var G__38120 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__38120;
continue;
...
var n__4666__auto___38121 = a.length;
var i_38122 = (0);
while(true){
if((i_38122 < n__4666__auto___38121)){
(a[i_38122] = reagent.impl.template.as_element((a[i_38122])));

var G__38123 = (i_38122 + (1));
i_38122 = G__38123;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4666__auto___38124 = a.length;
var i_38125 = (0);
while(true){
if((i_38125 < n__4666__auto___38124)){
var val_38126 = (a[i_38125]);
if(((cljs.core.vector_QMARK_(val_38126)) && ((reagent.impl.template.key_from_vec(val_38126) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_38125] = reagent.impl.template.as_element(val_38126));

var G__38127 = (i_38125 + (1));
i_38125 = G__38127;
continue;
} else {
}
...
var ctx = ({});
var vec__38024 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38024,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38024,(1),null);
...
var G__38027 = (cljs.core.count(argv) - first_child);
switch (G__38027) {
case (0):
