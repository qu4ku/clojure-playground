...
var len__4789__auto___29760 = arguments.length;
var i__4790__auto___29761 = (0);
while(true){
if((i__4790__auto___29761 < len__4789__auto___29760)){
args__4795__auto__.push((arguments[i__4790__auto___29761]));

var G__29762 = (i__4790__auto___29761 + (1));
i__4790__auto___29761 = G__29762;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29662){
var G__29663 = cljs.core.first(seq29662);
var seq29662__$1 = cljs.core.next(seq29662);
var G__29664 = cljs.core.first(seq29662__$1);
var seq29662__$2 = cljs.core.next(seq29662__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29663,G__29664,seq29662__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29666_SHARP_){
return (!((cljs.core.meta(p1__29666_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29734__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29738){var _e__27590__auto__ = e29738;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e29742){var _e__27590__auto__ = e29742;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__29744 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__29745 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__29745);

try{var map__29746 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29746__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__29744);
}});
...
var temp__5733__auto___29778 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___29778)){
var managed_print_level_29779 = temp__5733__auto___29778;
var _STAR_print_level_STAR__orig_val__29758_29780 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29759_29781 = managed_print_level_29779;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29759_29781);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__29757_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29757_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29758_29780);
}} else {
job_fn();
}
